...
entradasTreinamento = dadosTreinamento(1:numEntradas,:);
...
entradasValidacao = dadosValidacao(1:numEntradas,:);
        ...
        for iNumEsc = 1 : size(numEscondidos, 2)
            ...
            for iTaxalr = 1 : size(taxaslr, 2)
                ...
                for iEpoca = 1 : size(epocas, 2)
                    ...
                    rede.trainParam.max_fail = epoca;    % Criterio de quantidade maxima de falhas na validacao
                    ...
                    plotperform(desempenho);
                    title('Perform');
                    set(gcf, 'Position', [200 200 300 300]);
                    stringImagem = strcat('res\imagens\perform\', resFilename,'.png');
                    saveas(gcf, stringImagem);
