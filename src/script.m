...
numEscondidos = [2];                          % Numero de nodos escondidos
...
taxaslr = [0.001];                             % Taxas de aprendizagem
epocas = [10000];                              % Número de iterações (épocas)
